namespace CigarWorld.Data
{
    ...
    { 
        public class Cigar
        {
            ...
            public const int MinFormatLenght = 3;
            public const int MaxFormatLenght = 25;

            public const int MinLengthLenght = 50;
            ...
            public const int MaxCommentLenght = 1000;
        }
        ...
        public class Humidors 
        {
            ...
            public const int MinHeightLenght = 0;
            public const int MaxHeightLenght = 200;

            public const int MinLengthLenght = 0;
            public const int MaxLengthLenght = 200;
